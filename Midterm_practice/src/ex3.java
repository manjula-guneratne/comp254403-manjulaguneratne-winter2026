 ...
 */
public class ex3<E> implements Cloneable {
    //---------------- nested Node class ----------------
    /**
    ...
    public ex3() { }             // constructs an initially empty list
    ...
    //Clone
    public ex3<E> clone() throws CloneNotSupportedException{
        ex3<E> cloneOther = (ex3<E>) super.clone();
        if(size > 0) {
            //
    ...
    public void insertAfter(int key, int data) {
        ...
        do{
            if(current.getElement().equals(key)){
                Node<E> newNode = new Node<>((E) Integer.valueOf(data), current.getNext());
    ...
    public static void main(String[] args)
    {
        ...
        //(LAX, MSP, ATL, BOS)
        ex3<Integer> circularList = new ex3<Integer>();
